...
Entity {
    /**
     * @brief CarModel QML Type
     *
     * The CarModelSports type represents a sports car model in a 3D scene.
     *
     * It provides properties for controlling the visibility, rotation, camera position, light position, door states, highlighting, and door actions of the car model.
     *
     * @property hidden Whether the car model is hidden or not.
     * @property scene The 3D scene where the car model is placed.
     * @property carRotation The rotation angle of the car model.
     * @property previousComponent The previous component used for the car model.
     * @property previousMaterial The previous material used for the car model.
     * @property defaultCameraPosition The default position of the camera.
     * @property defaultLightPosition The default position of the light source.
     * @property lightPosition The position of the light source.
     * @property cameraPos The position of the camera.
     * @property lightPos The position of the light source.
     * @property lightPosMultiplier The multiplier for the light position.
     * @property door_left The state of the left door.
     * @property door_right The state of the right door.
     * @property door_trunk The state of the trunk door.
     * @property door_hood The state of the hood door.
     * @property highlighting Whether the car model is being highlighted or not.
     * @property doorAction Whether a door action is being performed or not.
     * @property highlightType The type of highlighting being applied.
     * @property defaultHighlight The default highlight value.
     */
    ...
    /**
       * @brief Preset camera positions for highlights.
       *
       * This component defines the preset camera positions for various highlights in the car model.
       * The positions are specified using vector3d coordinates.
       *
       * @property positionFrontLeftHigh - The position of the left headlight highlight.
       * @property positionFrontRightHigh - The position of the right headlight highlight.
       * @property positionFrontLeftLow - The position of the left day light highlight.
       * @property positionFrontRightLow - The position of the right day light highlight.
       * @property positionRearLeft - The position of the left tail light highlight.
       * @property positionRearRight - The position of the right tail light highlight.
       * @property positionLeftRear - The position of the left rear tire highlight.
       * @property positionLeftFront - The position of the left front tire highlight.
       * @property positionRightRear - The position of the right rear tire highlight.
       * @property positionRightFront - The position of the right front tire highlight.
       * @property positionLeft - The position of the left door highlight.
       * @property positionRight - The position of the right door highlight.
       * @property positionTop - The position of the top door highlight.
       * @property positionBack - The position of the trunk highlight.
       * @property positionFront - The position of the hood highlight.
       *
       * @property bodyColor - The color of the car body.
       * @property interiorColor - The color of the car interior.
       * @property highlightColor - The color of the highlights.
       */
