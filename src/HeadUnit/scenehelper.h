...
public:
    ...
    Q_INVOKABLE void addTextureMaterial(Qt3DRender::QSceneLoader *loader,
                                        Qt3DRender::QMaterial *material,
                                        QString name);
    Q_INVOKABLE void replaceMaterial(Qt3DRender::QSceneLoader *loader,
                                     const QString &name,
                                     Qt3DRender::QMaterial *material);
    Q_INVOKABLE void searchCamera(Qt3DRender::QSceneLoader *loader, const QString &name);

private:
    void addComponents(QStringList &names, Qt3DCore::QEntity *root, Qt3DRender::QMaterial *material);
